...
*********************************************************************************************************/
byte mcp2515::begin(byte speedset, const byte clockset) {
    pSPI->begin();
...
*********************************************************************************************************/
byte mcp2515::init_Mask(byte num, byte ext, unsigned long ulData) {
    byte res = MCP2515_OK;
    #if DEBUG_EN
...
*********************************************************************************************************/
void mcp2515::setSleepWakeup(const byte enable) {
...
*********************************************************************************************************/
byte mcp2515::setMode(const byte opMode) {
    if (opMode !=
...
*********************************************************************************************************/
byte mcp2515::checkReceive(void) {
    byte res;
...
*********************************************************************************************************/
byte mcp2515::readMsgBufID(byte status, volatile unsigned long* id, volatile byte* ext, volatile byte* rtrBit,
...
*********************************************************************************************************/
byte mcp2515::trySendMsgBuf(unsigned long id, byte ext, byte rtrBit, byte len, const byte* buf, byte iTxBuf) {
    byte txbuf_n;
...
*********************************************************************************************************/
byte mcp2515::sendMsgBuf(byte status, unsigned long id, byte ext, byte rtrBit, byte len, volatile const byte* buf) {
...
*********************************************************************************************************/
byte mcp2515::sendMsgBuf(unsigned long id, byte ext, byte rtrBit, byte len, const byte* buf, bool wait_sent) {
...
** Descriptions:            send buf
*********************************************************************************************************/
byte mcp2515::sendMsgBuf(unsigned long id, byte ext, byte len, const byte* buf, bool wait_sent) {
...
*********************************************************************************************************/
void mcp2515::clearBufferTransmitIfFlags(byte flags) {
    flags &= MCP_TX_INT;
    if (flags == 0) {
        return;
    }
...
*********************************************************************************************************/
byte mcp2515::readRxTxStatus(void) {
...
*********************************************************************************************************/
byte mcp2515::checkClearRxStatus(byte* status) {
    byte ret;
...
**                          with one single readRxTxStatus call.
*********************************************************************************************************/
byte mcp2515::checkClearTxStatus(byte* status, byte iTxBuf) {
    byte ret;
...
*********************************************************************************************************/
bool mcp2515::mcpPinMode(const byte pin, const byte mode) {
    byte res;
    bool ret = true;
...
*********************************************************************************************************/
bool mcp2515::mcpDigitalWrite(const byte pin, const byte mode) {
    switch (pin) {
        case MCP_RX0BF:
            switch (mode) {
                case HIGH:
...
*********************************************************************************************************/
byte mcp2515::mcpDigitalRead(const byte pin) {
    switch (pin) {
        case MCP_RX0BF:
...
*********************************************************************************************************/
byte mcp2515::mcp2515_readRegister(const byte address) {
    byte ret;
...
*********************************************************************************************************/
void mcp2515::mcp2515_readRegisterS(const byte address, byte values[], const byte n) {
    byte i;
    #ifdef SPI_HAS_TRANSACTION
    SPI_BEGIN();
    #endif
...
*********************************************************************************************************/
void mcp2515::mcp2515_setRegister(const byte address, const byte value) {
    #ifdef SPI_HAS_TRANSACTION
    SPI_BEGIN();
    #endif
    MCP2515_SELECT();
...
*********************************************************************************************************/
void mcp2515::mcp2515_setRegisterS(const byte address, const byte values[], const byte n) {
    byte i;
    #ifdef SPI_HAS_TRANSACTION
    SPI_BEGIN();
    #endif
...
*********************************************************************************************************/
void mcp2515::mcp2515_initCANBuffers(void) {
    byte i, a1, a2, a3;
...
*********************************************************************************************************/
void mcp2515::mcp2515_modifyRegister(const byte address, const byte mask, const byte data) {
    #ifdef SPI_HAS_TRANSACTION
    SPI_BEGIN();
    #endif
    MCP2515_SELECT();
...
*********************************************************************************************************/
byte mcp2515::mcp2515_readStatus(void) {
    byte i;
    #ifdef SPI_HAS_TRANSACTION
    SPI_BEGIN();
    #endif
...
*********************************************************************************************************/
byte mcp2515::mcp2515_setCANCTRL_Mode(const byte newmode) {
...
** Descriptions:            Set control mode
*********************************************************************************************************/
byte mcp2515::mcp2515_requestNewMode(const byte newmode) {
...
*********************************************************************************************************/
byte mcp2515::mcp2515_configRate(const byte canSpeed, const byte clock) {
...
*********************************************************************************************************/
byte mcp2515::mcp2515_init(const byte canSpeed, const byte clock) {
...
*********************************************************************************************************/
void mcp2515::mcp2515_write_id(const byte mcp_addr, const byte ext, const unsigned long id) {
    byte tbufdata[4];
...
*********************************************************************************************************/
void mcp2515::mcp2515_read_id(const byte mcp_addr, byte* ext, unsigned long* id) {
    byte tbufdata[4];
...
*********************************************************************************************************/
void mcp2515::mcp2515_write_canMsg(const byte buffer_sidh_addr, unsigned long id, byte ext, byte rtrBit, byte len,
...
*********************************************************************************************************/
void mcp2515::mcp2515_read_canMsg(const byte buffer_load_addr, volatile unsigned long* id, volatile byte* ext,
...
*********************************************************************************************************/
void mcp2515::mcp2515_start_transmit(const byte mcp_addr) {            // start transmit
    #ifdef SPI_HAS_TRANSACTION
    SPI_BEGIN();
    #endif
    MCP2515_SELECT();
...
*********************************************************************************************************/
byte mcp2515::mcp2515_getNextFreeTXBuf(byte* txbuf_n) {               // get Next free txbuf
...
*********************************************************************************************************/
byte mcp2515::mcp2515_isTXBufFree(byte* txbuf_n, byte iBuf) {         /* get Next free txbuf          */
    *txbuf_n = 0x00;
...
*********************************************************************************************************/
byte mcp2515::sendMsg(unsigned long id, byte ext, byte rtrBit, byte len, const byte* buf, bool wait_sent) {
